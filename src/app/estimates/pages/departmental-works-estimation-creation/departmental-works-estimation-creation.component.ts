...
@Component({
  selector: 'app-departmental-works-estimation-creation',
  templateUrl: './departmental-works-estimation-creation.component.html',
  styleUrls: ['./departmental-works-estimation-creation.component.scss'],
})
export class DepartmentalWorksEstimationCreationComponent implements OnInit {
  ...
  async ngOnInit() {
    this.route.paramMap.subscribe(async (params: ParamMap) => {
      ...
      const mainCategoryFilter: any = {         apiKey,
        serviceKey,
        userRole,
        userName,
        userCode,
      ...
      const estimateDetailData = await this.estimationRegisteredService.getDetailsByServiceIdAndStatusCode(detailFilter);
      ...
      // then implement this
      this.data = await this.dashboardService.getDataByServiceIdAndApplicationStatus(mainCategoryFilter);
