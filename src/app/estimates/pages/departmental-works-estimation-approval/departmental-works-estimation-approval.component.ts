...
@Component({
  selector: 'app-departmental-works-estimation-approval',
  templateUrl: './departmental-works-estimation-approval.component.html',
  styleUrls: ['./departmental-works-estimation-approval.component.scss'],
})
export class DepartmentalWorksEstimationApprovalComponent implements OnInit {
  estimatesList: any[] = [
    {
