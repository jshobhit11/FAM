...
@Component({
  selector: 'app-improvement-estimation-approval-list',
  templateUrl: './improvement-estimation-approval-list.component.html',
  styleUrls: ['./improvement-estimation-approval-list.component.scss'],
})
export class ImprovementEstimationApprovalListComponent implements OnInit {
  estimatesList: any[] = [];
  filterFields: string[] = [];
  cols: any[] = [];
  ...
  async ngOnInit() {
    ...
    this.estimatesList = await this.estimationRegistered.getImprovementEstimatesApprovalList(filter);
