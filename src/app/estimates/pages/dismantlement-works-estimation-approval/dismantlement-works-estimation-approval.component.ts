...
@Component({
  selector: 'app-dismantlement-works-estimation-approval',
  templateUrl: './dismantlement-works-estimation-approval.component.html',
  styleUrls: ['./dismantlement-works-estimation-approval.component.scss'],
})
export class DismantlementWorksEstimationApprovalComponent implements OnInit {
  estimatesList: any[] = [
    {
