...
@Component({
  selector: 'app-pvt-maintenance-details',
  templateUrl: './pvt-maintenance-details.component.html',
  styleUrls: ['./pvt-maintenance-details.component.scss']
})
export class PvtMaintenanceDetailsComponent implements OnInit {
  checklist: any[] = [];
  ...
  constructor(
    ...
    private maintenanceService:MaintenanceService
        ...
        goBack(){
         this.router.navigate(['/estimates/Preventive-maintenance-list']);
       }
}
