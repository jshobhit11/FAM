...
@Component({
  selector: 'app-improvement-estimation-creation-list',
  templateUrl: './improvement-estimation-creation-list.component.html',
  styleUrls: ['./improvement-estimation-creation-list.component.scss'],
})
export class ImprovementEstimationCreationListComponent implements OnInit {
  estimatesList: any[] = [];
  filterFields: string[] = [];
  cols: any[] = [];
  ...
  async ngOnInit() {
    ...
    this.estimatesList = await this.estimationRegistered.getImprovementEstimatesList(filter);
    ...
    this.cols = [
      { key: 'referenceNumber', title: 'Case ID', route: `/estimates/improvement-estimation` },
