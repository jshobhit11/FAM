...
@Component({
  selector: 'app-back-site-inspection',
  templateUrl: './back-site-inspection.component.html',
  styleUrls: ['./back-site-inspection.component.scss'],
})
export class BackSiteInspectionComponent implements OnInit {
  data: any = null;
  accountId: string = ''; 
