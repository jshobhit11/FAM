...
@Component({
  selector: 'app-improvement-works-far',
  templateUrl: './improvement-works-far.component.html',
  styleUrls: ['./improvement-works-far.component.scss']
})
export class ImprovementWorksFarComponent implements OnInit {
   ...
   async getDetails() {
     try {
       ...
       const response = await this.fieldactivityService.getDataByWorkorderNoToWorkExecution(detailsFilter);
   ...
   async chnageStatusToEstimation() {
     ...
     this.loader.show('Reverting to Work Execution...');
     try {
       ...
       this.saveData = await this.fieldactivityService.updateToWorkExecution(detailsFilter);
