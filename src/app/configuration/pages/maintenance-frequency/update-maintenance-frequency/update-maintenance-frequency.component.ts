...
@Component({
  selector: 'app-update-maintenance-frequency',
  templateUrl: './update-maintenance-frequency.component.html',
  styleUrls: ['./update-maintenance-frequency.component.scss']
})
export class UpdateMaintenanceFrequencyComponent implements OnInit {
  getData: any = {};
  filterData: any;
  notificationRef: any;
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<UpdateMaintenanceFrequencyComponent>,
