...
@Component({
  selector: 'app-config-budget-entry',
  templateUrl: './config-budget-entry.component.html',
  styleUrls: ['./config-budget-entry.component.scss']
})
export class ConfigBudgetEntryComponent implements OnInit {
