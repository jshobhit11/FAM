...
@Component({
  selector: 'app-config-divisional-budget-head',
  templateUrl: './config-divisional-budget-head.component.html',
  styleUrls: ['./config-divisional-budget-head.component.scss']
})
export class ConfigDivisionalBudgetHeadComponent implements OnInit {
