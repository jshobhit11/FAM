...
@Component({
  selector: 'app-material-indent-invoice-report',
  templateUrl: './material-indent-invoice-report.component.html',
  styleUrls: ['./material-indent-invoice-report.component.scss'],
})
export class MaterialIndentInvoiceReportComponent implements OnInit {
  ...
  async generateInvoiceReportReport() {
    this.getPdf().subscribe((data: any) => {
      ...
      link.href = fileURL;
      link.download = 'MaterialIndent Invoice Report' + '.pdf';
