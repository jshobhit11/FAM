...
import { DispatchMaterialInvoiceDetailsComponent } from '../../pages/dispatch-material-invoice-details/dispatch-material-invoice-details.component';
import { MatSnackBar, MatSnackBarConfig } from '@angular/material/snack-bar';
import * as XLSX from 'xlsx';

@Component({
  selector: 'app-invoice-serial-numbers',
  templateUrl: './invoice-serial-numbers.component.html',
  styleUrls: ['./invoice-serial-numbers.component.scss'],
})
export class InvoiceSerialNumbersComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DispatchMaterialInvoiceDetailsComponent>,
