...
import { MaterialSuspenseAcknowledgementComponent } from '../material-return-process/material-suspense-acknowledgement/material-suspense-acknowledgement.component';

@Component({
  selector: 'app-acknowledgement-serial-suspense',
  templateUrl: './acknowledgement-serial-suspense.component.html',
  styleUrls: ['./acknowledgement-serial-suspense.component.scss']
})
export class AcknowledgementSerialSuspenseComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<MaterialSuspenseAcknowledgementComponent>,
