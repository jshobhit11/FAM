...
@Component({
  selector: 'app-material-acknowledgement-suspense-report',
  templateUrl: './material-acknowledgement-suspense-report.component.html',
  styleUrls: ['./material-acknowledgement-suspense-report.component.scss']
})
export class MaterialAcknowledgementSuspenseReportComponent implements OnInit {
