...
@Component({
  selector: 'app-store-serial-material-report',
  templateUrl: './store-serial-material-report.component.html',
  styleUrls: ['./store-serial-material-report.component.scss']
})
export class StoreSerialMaterialReportComponent {
  data: any[] = [];
  officeMasterID: any[] = [];
  officeOptions: any[] = [];
  storeData: any[] = [];
